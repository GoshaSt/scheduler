...
def marks_list(request, stud_id):
    ...
    for ass in ass_list:
        try:
            ...
            sc.save()
            sc.marks_set.create(type='M', name='Midterm 1')
            sc.marks_set.create(type='R', name='РК 1')
            sc.marks_set.create(type='M', name='Midterm 2')
            sc.marks_set.create(type='R', name='РК 2')
            sc.marks_set.create(type='E', name='Экзамен')
        sc_list.append(sc)
